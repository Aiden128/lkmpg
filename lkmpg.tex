...
The Linux Kernel Module Programming Guide is available as a free book. You are permitted to reproduce and/or modify it in accordance with the terms stipulated in the \href{https://opensource.org/licenses/OSL-3.0}{Open Software License}, version 3.0.

Although this book is distributed with the hope that it will be useful, it comes without any warranty, even without the implied warranties of merchantability or fitness for a particular purpose.

The author encourages the broad distribution of this book for personal or commercial purposes, under the condition that the above copyright notice remains intact and that the distribution complies with the provisions of the \href{https://opensource.org/licenses/OSL-3.0}{Open Software License}.

In summary, you are free to copy and distribute this book, whether for free or for profit, without needing explicit permission from the author. This includes reproduction in any physical or electronic medium.

All derivative works and translations of this document must adhere to the Open Software License, and the original copyright notice must remain intact. If you have contributed new material to this book, you must make both the material and source code available for your revisions.
Please make revisions and updates available directly to the document maintainer, Jim Huang <jserv@ccns.ncku.edu.tw>.
Doing so will facilitate the merging of updates and ensure consistent revisions within the Linux community.

Should you publish or distribute this book commercially, the author and the \href{https://tldp.org/}{Linux Documentation Project} (LDP)  would greatly appreciate donations, royalties, and/or printed copies. Contributing in this manner demonstrates your support for free software and the LDP. For questions or comments, please contact the address provided above.
